...
import './settlement_notsettled.scss'
...
export default class SettlementNotSettled extends Taro.Component<{}, NotSettledState> {
        ...
        <View className='at-row'>
          <View className='at-col at-col-12'>
            ...
            <View className='flex-card card_margin'>
              <View className='at-row'>
                <View className='at-col at-col-4'>尚未结算</View>
